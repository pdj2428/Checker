...
{
    // 컬러 넘버 : 0 = 파, 1 = 빨, 2 = 노, 3 = 주, 4 = 초, 5 = 맛이 간 색(보라색 포함), 6 = 알고보니 착했던 색 
    ...
    public Image[] sns;//0 = 기사, 1 = 페북, 2 = 트위터
    public Sprite[] snsSprite;//0~7기사, 8~15 페북, 16~23 트위터
    ...
    private void SetDirective_SNSTexts()
    {
        ...
        if (day == 1)
        {
            directiveText.text = "안녕하신가, 검문관. 총리일세\n요즘 세상이 어수선한 건 알고 있을거야. 빨간색의\n바이러스가 퍼졌다는 얘기가 인터넷을 가득 채웠어.\n파랑색만 보던 사람들이 갑작스레 빨간색을 보게\n되니 놀라는 것은 당연하지. 나도 적잖이 당황했네.\n미디어를 확인해보니, 그들의 증상은 체온과 맥박\n수가 비정상적으로 높다고 하네.\n오늘부터 바이탈체크를 통해 체온이 37.5도 이상이\n거나 맥박수가 120 이상일 때 병원으로 이송시키게.\n패드로 SNS를 확인할 수 있네. 미디어로부터 많은\n정보를 얻을 수 있을거야.\n감염자를 볼 수 있는 검문소의 가림막을 통해 통과\n여부를 알려 줄 수 있다네.\n국민을 위하여 힘 써주시게";
        ...
        {
            directiveText.text = "안녕하신가, 검문관. 총리일세\n새로운 일은 적응이 되어가나? 적응이 안됐다면\n안타깝군.\n노란색의 바이러스도 퍼진 모양이야. 증상에 대한\n자세한 설명은 미디어를 확인하면 알 수 있네.\n오늘부터는 혈압과 호흡 수 까지 확인해야 하네.\n혈압이 150 이상이거나 호흡 수가 40 이상일 때\n병원으로 이송시키게.\n현재로서는 이게 최선일세, 의료진이 치료법을 내지\n못하는 이상, 자네가 우리의 목숨을 책임지는 걸세.\n나라를 위하여 힘 써주시게";
        ...
        {
            directiveText.text = "안녕하신가, 검문관. 총리일세\n안좋은 소식만 전하게 되는군. 이러다가 세상이\n망하지는 않을까 싶네.\n오늘 새벽, 주황색의 감염자가 도시에 들어오려다가\n잡혔네. 발견 당시에 가슴 통증을 앓고 있더군.\n최대한 단속시켰지만 기자들이 이미 퍼트려버렸네.\n아침부터 떠들썩해.\n오늘 발견된 감염자는 폐에 이상이 있을 것으로\n의료진들이 예상하더군.\n오늘부터 검문소 상단에 배치된 엑스레이를 사용해\n폐에 이상있는 감염자는 병원으로 이송시켜주게.\n정말 어쩌다가 이렇게 됐는지, 파란색인 우리만\n피해를 보는군.\n우리를 위하여 힘 써주시게";
        ...
        {
            directiveText.text = "안녕하신가, 검문관. 총리일세\n무능한 의료진이 한 건 해냈네.초록색의 감염자에\n대해 들어본 적 있나?\n 2일 전에 가족 전체가 초록색인 가정을 발견하고,\n그들의 대한 검사를 한 결과, 채혈을 통해\n정밀 검사를 할 수 있다는 걸 알게됐네.\n오늘부터는 혈액검사로도 확인할 수 있게 됐네.\nHBC수치 20000이상, RBC수치 300만 이하,\nHB수치 20 이상일 때 병원으로 이송 시켜주게.\n귀찮겠지만, 초록색 감염자를 볼 때는 항상 확인\n해야 하네. 파란색을 위하여 힘 써주시게.";
        ...
        {
            directiveText.text = "안녕하신가, 검문관. 총리일세\n오늘 올라온 기사를 읽어보았나? 충격적인 내용이\n담겨 있으니 꼭 읽어봐야 할걸세.\n오늘부터는 주민등록증을 검사해, 감염 이전에\n흑인이었던 이들의 출입을 제한해주게.\n기사에 따르면 그들은 모두 위험한 감염자로\n변했거나, 그럴 가능성이 높다고 하더군.\n백인을 위하여 힘 써주시게";
        ...
        {
            directiveText.text = "안녕하신가, 검문관. 총리일세\n혹시 검문관, B구역에 거주하고 있지는 않겠지?\n점점 바이러스의 대란이 끝나가는 것 같네.\nB구역에서부터 바이러스가 퍼져나갔다는 기사를\n접했어.지금 B구역 출신의 감염자들은 모두 이상\n증세가 있을 것이라고 전문가들이 얘기하고 있네.\n오늘부터는 주민등록증에서 B구역 출신인\n감염자들을 병원으로 이송하게.\n그들은 이상증세가 있을 테니 말이야.\nA구역을 위하여 힘 써주시게";
        ...
        {
            directiveText.text = "검문관, 부탁이 있네. 나 총리일세\n내 딸이 빨간색 감염자가 됐네. 그리고 아직\n도시를 들어오지 못했어.\n아직 딸은 주민등록증을 발급받지 못해\n신원파악을 할 수도 없네.\n그래서 말인데, 오늘만 빨간색 감염자를 모두\n받아주는 건 어떤가? 성공하고 싶지 않나?\n나를 위하여 힘 써주시게";
